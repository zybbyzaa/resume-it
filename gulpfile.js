...
gulp.task('styles', () => {
  return gulp
    .src(['node_modules/font-awesome/css/font-awesome.min.css', paths.styles])
    .pipe($.sass())
...
gulp.task('html', () => {
  ...
  const context = matter(fs.readFileSync('data.yaml', 'utf8'), {
    schema: YAML_SCHEMA
  }).data;
  return gulp
    .src(['template/index.html', 'template/print.html'])
